...
function RefundPolicy() {
  return (
    <div className="p-nav">
      ...
      <ul>
        <li>
          <p>
            ...
            this Agreement) refers to HomeChef website.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to HomeChef, accessible from{" "}
            <a
              href="https://www.homechef.com"
              target="_blank"
      ...
      <p>You are entitled to cancel Your Order within 7 days.</p>
      <p>
      ...
      <ul>
        <li>
          <p>By email: ambikaskitchen2034@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://www.homechef.com/contact"
              target="_blank"
              rel="noopener noreferrer"
            >
              https://www.homechef.com/contact
            </a>
          </p>
        </li>
        <li>
          <p>By phone number: +91 98180 19728</p>
        </li>
      </ul>
      <p>
      ...
      <p>A-5/334 IInd Floor, Paschim Vihar, New Delhi - 110063</p>
      <p>
