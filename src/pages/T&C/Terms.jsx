...
function Terms() {
  return (
    <div className="p-container">
      ...
      <p>Welcome to HomeChef Website!</p>
      <p>
        These terms and conditions (“Agreement”) set forth the general terms and
        conditions of your use of the homchef.com website (“Website” or
      ...
      <p>
        We employ the use of local storage. By accessing HomeChef By Ambika, you
        agreed to use cookies and local storage in agreement with the HomeChef's
        Privacy Policy.{" "}
      </p>
      <p>
        Most interactive websites use cookies/local storage to let us retrieve
        the user’s details for each visit. Cookies/Local Storage are used by our
      ...
      <p>
        ...
        Operator or its licensors. Other trademarks, service marks, graphics and
        logos used in connection with the Website and Services may be the
        trademarks of other third parties. Your use of the Website and Services
        grants you no right or license to reproduce or otherwise use any of the
      ...
      <p>
        ...
        the hyperlink compensates the absence of HomeChef; and (d) the link is
      ...
      <p>
        ...
        e-mail to HomeChef. Please include your name, your organization name,
      ...
      <p>
        No use of HomeChef's logo or other artwork will be allowed for linking
      ...
      <p>
        Please read{" "}
        <Link className="link blue" to="privacypolicy">
          Privacy Policy
        </Link>
      </p>
      <h3>
      ...
      <br />
      <br />
      <p>This document was last updated on December 23, 2021</p>
    </div>
  );
}
